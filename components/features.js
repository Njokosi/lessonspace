    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            <span className="relative">Easily</span>
          </span>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
        <div className="grid gap-6 md:grid-cols-2 md:col-span-2 lg:col-span-3">
          ...
          <div className="rounded lg:p-5 lg:transition lg:duration-300 lg:hover:bg-blue-50">
            <div className="flex items-center mb-1">
              <p className="text-lg font-semibold sm:text-base">Plan your budget</p>
            </div>
            <p className="text-sm text-gray-900">
          ...
          <div className="rounded lg:p-5 lg:transition lg:duration-300 lg:hover:bg-blue-50">
            <div className="flex items-center mb-1">
              <p className="text-lg font-semibold sm:text-base">Contract leases</p>
            </div>
            <p className="text-sm text-gray-900">
          ...
          <div className="rounded lg:p-5 lg:transition lg:duration-300 lg:hover:bg-blue-50">
            <div className="flex items-center mb-1">
              <p className="text-lg font-semibold sm:text-base">Instant payments</p>
            </div>
            <p className="text-sm text-gray-900">
