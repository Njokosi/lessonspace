        ...
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            >
              <img
                className="h-8"
                src="/images/lessonspacelogowhite.svg"
                alt="Lessonspace"
              />
            </a>
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-sm text-indigo-200">
                The Easiest Way to Teach Online. Teach live, one-on-one, or with
                a group, using the most versatile collaborative space for online
                lessons.
              </p>
            </div>
          </div>
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
                    className="text-indigo-200 transition-colors duration-300 hover:text-indigo-400"
                  >
                    Features
                  </a>
                </li>
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                ...
                <li>
                  ...
                  >
                    Jobs{" "}
                    <span className="bg-pink-600 px-2 py-0.5 rounded-full text-xs font-semibold tracking-wider text-white">
                      {" "}
                      Hiring{" "}
                    </span>
                  </a>
